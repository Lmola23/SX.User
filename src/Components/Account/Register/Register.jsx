...
export default function RegisterModern() {
  ...
  const registerUser = async (deviceToken) => {
    try {
      const response = await fetch("https://luismola-001-site3.qtempurl.com/api/Cliente/Account/register", {
        method: "POST",
  ...
  const handleLogin = async () => {
    try {
      const response = await fetch("https://luismola-001-site3.qtempurl.com/api/Cliente/Account/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
