...
const NuevoSelectorDeCitas = () => {
  ...
  useEffect(() => {
    const obtenerDiasDisponibles = async () => {
      try {
        const respuesta = await fetch("https://luismola-001-site2.qtempurl.com/api/Cliente/Disponibilidad");
  ...
  useEffect(() => {
    const obtenerServicios = async () => {
      try {
        const respuesta = await fetch("https://luismola-001-site2.qtempurl.com/api/Cliente/Servicio");
  ...
  const esDiaDisponible = (fecha) =>
    ...
    const confirmarCita = async () => {
      ...
      try {
        const respuesta = await fetch("https://luismola-001-site2.qtempurl.com/api/ClienteCitas/ReservarCita", {
          method: "POST",
